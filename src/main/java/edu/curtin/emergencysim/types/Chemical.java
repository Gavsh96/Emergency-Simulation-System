...
public class Chemical implements Emergencies 
{
    ...
    public Chemical(Subject observerE)
    {
    ...
    {
        System.out.println("chemical do not have an low intensity state");
        return null;
    }
    ...
    {
        System.out.println("chemical do not have an high intensity state");
        return null;
    }
